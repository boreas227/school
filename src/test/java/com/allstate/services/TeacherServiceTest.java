...
public class TeacherServiceTest {
    ...
    public void shouldFindTeachersOlderThan50() throws Exception {
        ArrayList<Teacher> teachers = this.teacherService.findByAgeGreaterThan(50);
        assertEquals(1, teachers.size());
    }

    @Test
    public void shouldNotFindAnyTeachersOlderThan100() throws Exception {
        ArrayList<Teacher> teachers = this.teacherService.findByAgeGreaterThan(100);
    ...
    public void shouldFindAllTheKlassesTaughtByTeacher() throws Exception {
        ArrayList<Klass> klasses = this.teacherService.findById(2).getKlasses();
    ...
    public void shouldFindNoKlassesTaughtByTeacher() throws Exception {
        ArrayList<Klass> klasses = this.teacherService.findById(3).getKlasses();
